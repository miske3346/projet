	...
	<div class="login-header box-shadow">
		<div class="container-fluid d-flex justify-content-between align-items-center">
			...
			<div class="login-menu">
				<ul>
					<li><a href="{{ route('users.login') }}">Connectez-vous</a></li>
				</ul>
			</div>
		</div>
	</div>
		...
		<div class="container">
			<div class="row align-items-center">
				<div class="col-md-6 col-lg-7">
					<img src="{{ asset('admin/vendors/images/blood.png') }}" alt="">
				</div>
								...
								<section>
									...
									<div class="form-wrap max-width-600 mx-auto">
										<div class="form-group row">
											<label class="col-sm-4 col-form-label">votre Address mail</label>
											<div class="col-sm-8">
									...
									<div class="form-wrap max-width-600 mx-auto">
										...
										{{-- <div class="col-md-6">
											<div class="form-group">
												<label class="col-sm-4 col-form-label">Select City :</label>
												<select class="custom-select form-control">
													<option value="">Select City</option>
													<option value="Amsterdam">India</option>
													<option value="Berlin">UK</option>
		...
		<div class="modal-dialog modal-dialog-centered max-width-400" role="document">
			<div class="modal-content">
				...
				<div class="modal-footer justify-content-center">
					<a href="{{ route('users.login') }}" class="btn btn-primary">Done</a>
				</div>
			</div>
		</div>
	</div>
